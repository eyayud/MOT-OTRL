...
namespace CUSTOR.OTRLS.API.Migrations
{
    ...
    [Migration("20190423125838_create user, user porifle and sectors table")]
    partial class createuseruserporifleandsectorstable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CUSTOR.OTRLS.Core.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CUSTOR.OTRLS.Core.ApplicationUserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CUSTOR.OTRLS.Core.ApplicationUserProfile", b =>
                {
                    b.HasOne("CUSTOR.OTRLS.Core.ApplicationUser", "User")
                        .WithOne("ApplicationUserProfile")
                        .HasForeignKey("CUSTOR.OTRLS.Core.ApplicationUserProfile", "UserId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("CUSTOR.OTRLS.Core.ApplicationUser")
                        .WithMany()
