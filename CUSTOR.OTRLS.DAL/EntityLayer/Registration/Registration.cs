...
namespace CUSTOR.OTRLS.Core
{
    public class Registration
    {
        ...
        public int LegalCondition { get; set; }
        ...
        public string PreviousRegNumber { get; set; }
        public string MainCancellationReason { get; set; }
        ...
        [NotMapped] public string[] RegistrationCatagories { get; set; }
        ...
        public string PersonCancelledRegistration { get; set; }
